...
import file from "./markdown/easy-email-pro.md?raw";
...
export default function MyEditor() {
  ...
  const initialValues: EmailTemplate | null = useMemo(() => {
    return {
      subject: "markdown preview",
      content: json as EmailTemplate["content"],
    };
  }, [json]);
  ...
  return (
    <EmailEditorProvider {...config}>
      <EditorHeader
        extra={
          <MarkdownEditor initialValue={file}>
            <Button>
