...
import { SimpleSectionCustomBlock } from "./customWrapper";
import { CustomWrapper } from "./customWrapper/CustomWrapper";

ElementMap[CustomBlockType.SIMPLE_WRAPPER_CUSTOM_BLOCK] = CustomWrapper;

console.log(`ElementMap`, ElementMap);
BlockManager.registerBlocks([SimpleSectionCustomBlock]);

ConfigPanelsMap[CustomBlockType.SIMPLE_WRAPPER_CUSTOM_BLOCK] =
  ConfigPanelsMap[ElementType.STANDARD_SECTION];
...
const categories: ThemeConfigProps["categories"] = [
  {
    ...
    blocks: [
...

      {
        ...
        payload: {
          type: "simple_custom_wrapper_block",
          data: {},
          attributes: {
            "padding-bottom": "0px",
          },
